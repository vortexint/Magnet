...
enum class AudioFilterType { LOWPASS, HIGHPASS, BANDPASS };
...
struct AudioFilter {
  ...
  static std::optional<AudioFilter> create(
    AudioFilterType, std::optional<AudioFilterDescription>);
  void destroy();
